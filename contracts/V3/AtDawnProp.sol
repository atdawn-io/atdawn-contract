...
contract AtDawnProp is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("https://cdn.atdawn.io/api/props/") Ownable(_msgSender()) {
        _name = "ATDAWN PROPS NFT";
        _symbol = "ADPN";
    }
