...
abstract contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, IERC1155Errors {
    ...
    function uri(uint256 id) public view virtual returns (string memory) {
         return bytes(_uri).length > 0 ? strConcat(string(abi.encodePacked(_uri, toString(id))), ".json"): "";
    }
    ...
    function ownerOfToken(uint256 _id) public view returns (address[] memory) {
...
contract AtDawnWeapon is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    event Operator(address account,bool value);

    constructor() ERC1155("https://atdawn.io/nft/weapons/api/") Ownable(_msgSender()) {
        _name = "ATDAWN WEAPON NFT";
        _symbol = "ADWN";
    }
